...
public class LoggingEventCache {
    ...
    private long lastPublishEpoch;

    private long publish_interval;
    ...
    public LoggingEventCache(String cacheName, int capacity,
                             ICachePublisher cachePublisher, long publishInterval) {
        this.cacheName = cacheName;
        this.capacity = capacity;
        this.cachePublisher = cachePublisher;
        executorService = createExecutorService();
        this.lastPublishEpoch = new Date().getTime() / 1000;
        this.publish_interval=publishInterval;
    }
    ...
    public void add(LoggingEvent event) {
        ...
        synchronized (EVENTQUEUELOCK) {
            if (eventQueueLength < capacity && now - lastPublishEpoch < publish_interval) {
